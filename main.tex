...
singlespacing, % Single line spacing, choose from: singlespacing, onehalfspacing or doublespacing
...
\usepackage{subfiles} % Use subfiles inputing files
...
\usepackage{xstring}
\usepackage{listings}
\usepackage{yourcommands}% All custom commands for writing this thesis
